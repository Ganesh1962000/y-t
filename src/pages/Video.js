  ...
  return (
    <section className="video_page">
      <div className="container mt-4">
        <div className="row">
          <div id="primary" className="col-7">
            ...
            <div className="video_detials mb-3 justify-content-between d-flex">
              <div className="owner_dtl d-flex align-items-center">
                ...
                <div className="channel_dtl mx-3">
                  <p>
                    {data?.channel} {<CheckCircleIcon id="verified_icon" />}
                  </p>
              ...
              <div className="like_detials d-flex align-items-center">
                <ButtonGroup
                  ...
                  id="like_grp"
                >
                  <Button id="like_btn" startIcon={<ThumbUpOutlinedIcon />}>
                    121K
                  </Button>
                  <Button
                    id="like_btn"
                ...
                <Button id="control_btn" startIcon={<ReplyOutlinedIcon />}>
                  Share
                </Button>
                <Button id="control_btn" startIcon={<ContentCutIcon />}>
                  Clip
                </Button>
                <IconButton id="dtl control_btn">
                  <MoreHorizIcon />
                </IconButton>
              </div>
            </div>
            ...
            <div className="comment_wraper">
              <div className="cmt_dtl mb-3">
                ...
                <Button id="sort_btn" startIcon={<SortIcon />}>
                  Sort by
                </Button>
              </div>
          ...
          <div id="secondary" className="col-5">
            <div>
              {videos.map((video, i) => {
                if (video.id !== id) {
                  return (
